...
1. удаление ресурсов, 54 минуты останавливался траффик, а потом зависла на остановке инстанса и это еще больше часа, в итоге не выдержал руками ВМ через web - интерфейс поудалял.
